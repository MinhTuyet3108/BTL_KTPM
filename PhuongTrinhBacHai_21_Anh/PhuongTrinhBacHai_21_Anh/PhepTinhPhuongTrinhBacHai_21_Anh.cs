...
namespace PhuongTrinhBacHai_21_Anh
{
    ...
    public class PhepTinhPhuongTrinhBacHai_21_Anh
    {
        ...
        {
            // Nếu a b c không phải là số hợp lệ -> có thể là chử hoặc ký tự đặc biệt thì sẽ chạy điều kiện này
            if (double.IsNaN(a_21_Anh) || double.IsNaN(b_21_Anh) || double.IsNaN(c_21_Anh))
            {
